...
from module_pipe import GPTNeoForSequenceClassificationPipe

model = GPTNeoForSequenceClassification.from_pretrained("/home/oai/share/HuggingFace/gpt-neo-2.7B")
tokenizer = GPT2Tokenizer.from_pretrained("/home/oai/share/HuggingFace/gpt-neo-2.7B")
# model.parallelize()
...
engine = deepspeed.init_inference(model, mp_size=2)
