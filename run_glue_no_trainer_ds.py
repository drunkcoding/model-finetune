...
def main():
    ...
    model, optimizer, _, _ = deepspeed.initialize(args, model, mpu=mpu, model_parameters=optimizer_grouped_parameters)
    ...
    progress_bar = tqdm(range(args.max_train_steps), disable=not args.local_rank <= 0)
    completed_steps = 0
