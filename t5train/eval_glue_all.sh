...
MODEL_LIST=( "t5-small-lm-adapt" "t5-base-lm-adapt" "t5-base-lm-adapt" )

MODEL_TYPE=t5-xl-lm-adapt
BASE_DIR=/jmain02/home/J2AD002/jxm12/lxx22-jxm12/model-finetune/outputs/google/${MODEL_TYPE}/all

for CKPT in $(ls ${BASE_DIR} | grep checkpoint); do 
    model_path=${BASE_DIR}/${CKPT}
    ~/.conda/envs/torch/bin/python t5train/eval_glue_all.py \
    --model_name_or_path ${model_path} \
    --output_dir . \
    --dataset_name glue \
    --task_name all > t5eval/${MODEL_TYPE}_${CKPT}.log
done
